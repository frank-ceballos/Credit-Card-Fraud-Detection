...
data = pd.read_csv(data_prefix + file_name)
...
# Save figure
plt.savefig("amount distribution.png", dpi = 1080)
...
avg_fraud_amount = round(np.mean(fraud_amount),2)
...
# Save Figure
plt.savefig("Recall Scores Bar Plot.png", dpi = 1200)
...
# Save Figure
plt.savefig("Test Precision Score Bar Plot.png", dpi = 1200)
...
#################################################################################
#15. Get False Positives and True Positives in Test Set for Extra Trees Ensemble#
#################################################################################
# Classifier
...
# Save figure
g.savefig("FP TP Pair Plot.png", dpi = 1080)